...
const MobileMenu: React.FC<MobileMenuProps> = ({ isOpen, onClose, scrollToSection }) => {
  ...
  return (
    <div className="fixed inset-0 z-40 bg-zinc-950/90 backdrop-blur-sm md:hidden">
      <div className="h-20">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <a 
          ...
          className="block bg-salmon hover:bg-salmon-dark text-white font-medium px-4 py-3 rounded-lg text-center transition-colors duration-300"
        >
          Comprar Agora
        </a>
        ...
        <div className="mt-10 pt-8 border-t border-zinc-800">
          <div className="flex justify-between">
            <div className="flex items-center">
              <span className="text-fuchsia text-2xl mr-2">🤖</span>
